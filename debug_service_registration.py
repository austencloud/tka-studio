...
def test_service_registration():
    try:
        ...
        try:
            print("✅ ServiceRegistrationManager available")
            ...
            print("✅ PictographServiceRegistrar available")
            ...
            service = container.resolve(IPictographRenderingService)
            print(
                f"✅ IPictographRenderingService found after manual registration: {type(service)}"
            )
