...
def debug_start_position_selection():
    ...
    try:
        ...
        from desktop.modern.main import main
        ...
        from desktop.modern.presentation.components.start_position_picker.start_position_picker import StartPositionPicker
        ...
        workbench = construct_tab.findChild(object, "workbench")  # Try to find workbench
        if workbench:
