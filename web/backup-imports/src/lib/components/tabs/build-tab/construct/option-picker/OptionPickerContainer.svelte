...
<script lang="ts">
  ...
  import { createOptionDataState } from "./state/focused/option-data-state.svelte";
  import { createOptionUIState } from "./state/focused/option-ui-state.svelte";
  import { createOptionFilterState } from "./state/focused/option-filter-state.svelte";
  import { createOptionPersistenceState } from "./state/focused/option-persistence-state.svelte";
