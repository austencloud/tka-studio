...
import type { PropState } from "$lib/animator/types/PropState.js";
 ...
 */
export function updateCoordinatesFromAngle(propState: PropState): void {
 ...
 */
export function calculateCoordinatesFromAngle(centerPathAngle: number): {
  x: number;
  y: number;
} {
