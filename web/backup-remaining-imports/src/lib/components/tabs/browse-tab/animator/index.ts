...
// Animation engine
export { SequenceAnimationEngine as StandalonePortedEngine } from "$lib/animator/core/engine/sequence-animation-engine.js";

// Math services (replaces standalone-math.js)
export * from "$lib/animator/utils/math/index.js";
...
// Canvas utilities
export { CanvasRenderer } from "$lib/animator/utils/canvas/CanvasRenderer.js";
export { SVGGenerator } from "$lib/animator/utils/canvas/SVGGenerator.js";
