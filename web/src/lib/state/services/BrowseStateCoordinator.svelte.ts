...
import type { IBrowseNavigationStateService } from "./BrowseNavigationStateService.svelte";
import type { IBrowseSearchStateService } from "./BrowseSearchStateService.svelte";
import type { IBrowseSelectionStateService } from "./BrowseSelectionStateService.svelte";
...
export class BrowseStateCoordinator implements IBrowseStateCoordinator {
  ...
  constructor(
    private filterState: IBrowseFilterStateService,
    private navigationState: IBrowseNavigationStateService,
    private selectionState: IBrowseSelectionStateService,
    private displayState: IBrowseDisplayStateService,
    private searchState: IBrowseSearchStateService,
