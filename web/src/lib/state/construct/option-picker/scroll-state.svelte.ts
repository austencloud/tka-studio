export function createScrollState() {
  let scrollPosition = $state({ top: 0, left: 0 });
...
} from "$lib/services/implementations/construct/PictographOrganizerService";
import type { ResponsiveLayoutConfig, ScrollBehaviorConfig } from "./config";
import type { FoldableDetectionResult } from "./utils/deviceDetection";
import type { DeviceInfo, LayoutMetrics } from "./utils/layoutUtils";
import { createLayoutMetricsCalculator } from "./utils/scrollLayoutMetrics";
