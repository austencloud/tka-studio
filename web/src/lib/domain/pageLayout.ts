...
export const MEASUREMENT_UNITS: Record<string, MeasurementUnit> = {
  ...
  millimeters: { name: 'millimeters', pointsPerUnit: 72 / 25.4, displayName: 'mm' },
  centimeters: { name: 'centimeters', pointsPerUnit: 72 / 2.54, displayName: 'cm' },
};
...
export type OptimizationGoal = 'maximize_card_size' | 'minimize_pages' | 'balanced';
