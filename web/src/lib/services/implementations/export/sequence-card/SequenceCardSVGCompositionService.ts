/**
 * Sequence Card SVG Composition Service
 *
  ...
  implements ISequenceCardSVGCompositionService
{
  ...
  calculateResponsiveDimensions(
    ...
    try {
      ...
      const responsiveDimensions: SequenceCardDimensions = {
  ...
  private createContainerSVG(dimensions: SequenceCardDimensions): string {
