...
import type { ISvgColorTransformationService } from "$lib/services/interfaces/pictograph-interfaces";

export class SvgColorTransformationService
  implements ISvgColorTransformationService
{
