/**
 * Sequence Card Export Progress Tracker
 *
 * Tracks progress for sequence card export operations.
...
export class SequenceCardExportProgressTracker
  implements ISequenceCardExportProgressTracker
{
