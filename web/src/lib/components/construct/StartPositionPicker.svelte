...
<script lang="ts">
	...
	async function handleSelect(startPosPictograph: PictographData) {
		...
		try {
			...
			if (startPositionService) {
				console.log('🚀 StartPositionPicker: Calling startPositionService.setStartPosition');
				await startPositionService.setStartPosition(startPositionBeat);
				console.log('🚀 StartPositionPicker: startPositionService.setStartPosition completed');
			}

			// Call callback to notify parent component
			console.log('🚀 StartPositionPicker: Calling onStartPositionSelected callback');
			onStartPositionSelected(startPositionBeat);
			console.log('🚀 StartPositionPicker: onStartPositionSelected callback completed');
			...
			console.log('🚀 StartPositionPicker: Event dispatched - coordination service should handle the rest');
