...
<script lang="ts">
	...
	$effect(() => {
		...
		console.log('🔍 BuildTabContent currentSequence.start_position exists:', !!currentSequence?.start_position);
		console.log('🔍 BuildTabContent singleton sequence exists:', !!sequenceStateService.currentSequence);
		console.log('🔍 BuildTabContent singleton start_position exists:', !!sequenceStateService.currentSequence?.start_position);
	});
