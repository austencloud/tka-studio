// src/lib/components/construct/option-picker/utils/layoutConfig.ts (Simplified Aspects)
...
export const LAYOUT_RULES: LayoutRule[] = [
  ...
  },
  {
    ...
    when: {
      ...
      extraCheck: (w) => w > 2400, // Increased threshold to prevent 5 columns on normal wide screens
    },
  },
];
...
export const GRID_GAP_OVERRIDES: GridGapOverride[] = [
  ...
  },
  {
    ...
    when: {
      aspect: "wide",
      extraCheck: (w, _h, params) => w > 1400 && params?.device === "desktop",
    },
  },
  {
