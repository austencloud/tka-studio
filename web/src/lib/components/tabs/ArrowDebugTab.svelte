              ...
              <div class="control-group">
                ...
                <label class="checkbox-label">
                  <input
                    ...
                    onchange={() =>
                      handleStepByStepToggle(debugState.stepByStepMode)}
                  />
                  Step-by-step mode
                </label>
                <label class="checkbox-label">
                  <input
                    ...
                    onchange={() =>
                      handleAutoUpdateToggle(debugState.autoUpdate)}
                  />
                  Auto-update
                </label>
              </div>
                ...
                <div class="position-cards">
                  {#if debugState.selectedPictograph?.arrows?.red}
                    <div class="position-card red">
                      <h5>🔴 Red Arrow</h5>
                      <p>
                        X: {debugState.currentDebugData.finalPosition.x.toFixed(
                          2
                        )}
                      </p>
                      <p>
                        Y: {debugState.currentDebugData.finalPosition.y.toFixed(
                          2
                        )}
                      </p>
                      <p>
                        Rotation: {debugState.currentDebugData.finalRotation.toFixed(
                          2
                        )}°
                      </p>
                    </div>
    ...
    {#if debugState.selectedPictograph}
      <div class="debug-steps-panel">
        <HorizontalDebugSteps
          debugData={debugState.stepByStepMode
            ? debugState.currentStepData
            : debugState.currentDebugData}
