<script lang="ts">
  ...
  let { debugData, expandedSections, onToggleSection, isCalculating }: Props =
    $props();
...
<div class="debug-info">
  ...
  <div class="info-sections">
        ...
        <div class="section-content">
          {#if debugData.pictographData}
            <div class="data-item">
              ...
              {debugData.pictographData.letter || debugData.pictographData.id}
            </div>
          {/if}
          ...
          {#if debugData.arrowData}
            <div class="data-item">
              <strong>Arrow Color:</strong>
              {debugData.arrowData.color}
            </div>
          {/if}
        </div>
      {/if}
    ...
    <div class="section">
      ...
      >
        <span class="icon"
          >{isExpanded("location_calculation") ? "▼" : "▶"}</span
        >
        Step 1: Location Calculation
        {#if debugData.calculatedLocation}
          <span class="result-badge success"
            >{debugData.calculatedLocation}</span
          >
        {:else}
      ...
      {#if isExpanded("location_calculation")}
        <div class="section-content">
          {#if debugData.locationDebugInfo}
            <div class="data-item">
              <strong>Motion Type:</strong>
              {debugData.locationDebugInfo.motionType}
            </div>
            <div class="data-item">
              <strong>Calculation Method:</strong>
              {debugData.locationDebugInfo.calculationMethod}
            </div>
            <div class="data-item">
              <strong>Start Orientation:</strong>
    ...
    <div class="section">
      ...
      >
        ...
        {#if debugData.initialPosition}
          <span class="result-badge success">
            ({debugData.initialPosition.x.toFixed(1)}, {debugData.initialPosition.y.toFixed(
              1
            )})
          </span>
        {:else}
        ...
        <div class="section-content">
          {#if debugData.coordinateSystemDebugInfo}
            <div class="data-item">
              ...
              ({debugData.coordinateSystemDebugInfo.sceneCenter.x}, {debugData
                .coordinateSystemDebugInfo.sceneCenter.y})
            </div>
            <div class="data-item">
              <strong>Scene Dimensions:</strong>
              {debugData.coordinateSystemDebugInfo.sceneDimensions[0]} × {debugData
                .coordinateSystemDebugInfo.sceneDimensions[1]}
            </div>
            <div class="data-item">
              <strong>Coordinate Set Used:</strong>
    ...
    <div class="section">
      ...
      >
        ...
        {#if debugData.defaultAdjustment}
          <span class="result-badge success">
            ({debugData.defaultAdjustment.x.toFixed(1)}, {debugData.defaultAdjustment.y.toFixed(
              1
            )})
          </span>
        {:else}
        ...
        <div class="section-content">
          {#if debugData.defaultAdjustmentDebugInfo}
            <div class="data-item">
              ...
              {debugData.defaultAdjustmentDebugInfo.placementKey}
            </div>
            <div class="data-item">
              <strong>Turns:</strong>
              {debugData.defaultAdjustmentDebugInfo.turns}
            </div>
            <div class="data-item">
              <strong>Grid Mode:</strong>
              {debugData.defaultAdjustmentDebugInfo.gridMode}
            </div>
            <div class="data-item">
              <strong>Adjustment Source:</strong>
              {debugData.defaultAdjustmentDebugInfo.adjustmentSource}
            </div>
          {/if}
        </div>
      {/if}
    ...
    <div class="section">
      ...
      >
        ...
        {#if debugData.specialAdjustment}
          <span class="result-badge success">
            ({debugData.specialAdjustment.x.toFixed(1)}, {debugData.specialAdjustment.y.toFixed(
              1
            )})
          </span>
        {:else}
        ...
        <div class="section-content">
          {#if debugData.specialAdjustmentDebugInfo}
            <div class="data-item">
              ...
              {debugData.specialAdjustmentDebugInfo.letter}
            </div>
            <div class="data-item">
              <strong>Orientation Key:</strong>
              {debugData.specialAdjustmentDebugInfo.oriKey}
            </div>
            <div class="data-item">
              <strong>Turns Tuple:</strong>
              {debugData.specialAdjustmentDebugInfo.turnsTuple}
            </div>
            <div class="data-item">
              <strong>Special Placement Found:</strong>
              {debugData.specialAdjustmentDebugInfo.specialPlacementFound
                ? "Yes"
                : "No"}
            </div>
            <div class="data-item">
              <strong>Adjustment Source:</strong>
              {debugData.specialAdjustmentDebugInfo.adjustmentSource}
            </div>
          {/if}
        </div>
      {/if}
    ...
    <div class="section">
      ...
      >
        ...
        {#if debugData.tupleProcessedAdjustment}
          <span class="result-badge success">
            ({debugData.tupleProcessedAdjustment.x.toFixed(1)}, {debugData.tupleProcessedAdjustment.y.toFixed(
              1
            )})
          </span>
        {:else}
        ...
        <div class="section-content">
          {#if debugData.tupleProcessingDebugInfo}
            <div class="data-item">
              ...
              ({debugData.tupleProcessingDebugInfo.baseAdjustment.x}, {debugData
                .tupleProcessingDebugInfo.baseAdjustment.y})
            </div>
            <div class="data-item">
              <strong>Quadrant Index:</strong>
              {debugData.tupleProcessingDebugInfo.quadrantIndex}
            </div>
            <div class="data-item">
              <strong>Selected Tuple:</strong>
              [{debugData.tupleProcessingDebugInfo.selectedTuple[0]}, {debugData
                .tupleProcessingDebugInfo.selectedTuple[1]}]
            </div>
            <div class="data-item">
              <strong>Transformation Method:</strong>
              {debugData.tupleProcessingDebugInfo.transformationMethod}
            </div>
          {/if}
        </div>
      {/if}
        ...
        {#if isExpanded("performance")}
          <div class="section-content">
            <div class="data-item">
              ...
              {debugData.timing.totalDuration.toFixed(2)}ms
            </div>
