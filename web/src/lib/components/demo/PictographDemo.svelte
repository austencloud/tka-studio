    ...
    try {
      ...
      if (randomOptions.length > 0) {
        ...
        if (randomPictograph) {
          ...
          console.log(
            `🎲 Generated random pictograph: ${randomPictograph.letter}`
          );
        }
      }
    } catch (error) {
...
<div class="pictograph-demo">
  ...
  <div class="demo-grid">
    ...
    <div class="demo-item" data-testid="main-pictograph-demo">
      <h3>
        Real CSV Pictograph: {currentPictographData()?.letter || "Unknown"}
      </h3>
    ...
    <div class="data-preview">
      ...
      {#if currentPictographData()}
        <div class="data-scroll">
          <pre><code>{JSON.stringify(currentPictographData(), null, 2)}</code
            ></pre>
        </div>
      {:else}
