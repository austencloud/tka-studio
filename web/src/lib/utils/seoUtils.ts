...
export function getDefaultTKAMetadata(): SEOMetadata {
  return {
    ...
    description: 'The Kinetic Alphabet (TKA) is a digital notation system for kinetic movement and flow arts. Create, learn, and share movement sequences with visual pictographs.',
    keywords: [
      'TKA',
      'The Kinetic Alphabet',
      'dance notation',
 ...
 */
export function generatePageMetadata(page: string, data?: any): SEOMetadata {
  ...
  switch (page) {
    case 'browse':
      return {
        ...
        description: 'Browse and discover TKA movement sequences. Filter by difficulty, author, length, and more.',
        keywords: [...(baseMetadata.keywords || []), 'browse sequences', 'sequence library']
      };
    ...
    case 'construct':
      return {
        ...
        description: 'Create and build new TKA movement sequences using our interactive constructor.',
        keywords: [...(baseMetadata.keywords || []), 'create sequences', 'sequence builder', 'constructor']
      };
    ...
    case 'learn':
      return {
        ...baseMetadata,
        title: 'Learn TKA - TKA',
        description: 'Learn The Kinetic Alphabet notation system and improve your movement skills.',
        keywords: [...(baseMetadata.keywords || []), 'learn TKA', 'tutorials', 'education']
      };
    ...
    case 'about':
      return {
        ...
        description: 'Learn about The Kinetic Alphabet (TKA) notation system and its applications in movement and flow arts.',
        keywords: [...(baseMetadata.keywords || []), 'about TKA', 'notation system', 'movement theory']
      };
