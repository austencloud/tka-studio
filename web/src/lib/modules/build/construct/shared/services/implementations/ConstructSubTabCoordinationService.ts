...
import type { BeatData, GridMode, SequenceData } from "$shared/domain";
...
@injectable()
export class ConstructSubTabCoordinationService
  implements IConstructSubTabCoordinationService
{
