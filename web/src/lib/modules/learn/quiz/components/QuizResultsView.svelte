...
<script lang="ts">
  ...
  function getLessonDisplayName(results: QuizResults | null): string {
  ...
  function getQuizModeDisplayName(results: QuizResults | null): string {
  ...
  function getPerformanceFeedback(results: QuizResults): string {
  ...
  function getAchievements(results: QuizResults): string[] {
    ...
    {#if results}
      ...
      <div class="results-card glass-surface">
        <div class="performance-summary">
          <div
            class="grade-circle"
            style="border-color: {getPerformanceGrade(
              results.accuracyPercentage
            ).color}"
          >
            <span
              class="grade-letter"
              style="color: {getPerformanceGrade(results.accuracyPercentage)
                .color}"
            >
        ...
        <div class="stats-grid">
          ...
          <div class="stat-item">
            <span class="stat-value"
              >{formatTime(results.completionTimeSeconds)}</span
            >
