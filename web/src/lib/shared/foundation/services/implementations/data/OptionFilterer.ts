...
import { getLetterType } from "../../../../domain/enums/Letter";
import type { BeatData } from "../../../../domain/models/sequence";
import type { PictographData } from "../../../../pictograph/domain/models";
...
interface IGridPositionDeriver {
  ...
  getGridPositionFromLocations(blueLocation: any, redLocation: any): any;
}
...
export class OptionFilterer implements IOptionFilterer {
  constructor(
    ...
    private positionService: IGridPositionDeriver
  ) {}
   ...
   * Computes end position from motion data using GridPositionDeriver
   */
  extractEndPosition(lastBeat: BeatData): string | null {
    try {
      ...
      const endPosition = this.positionService.getGridPositionFromLocations(
