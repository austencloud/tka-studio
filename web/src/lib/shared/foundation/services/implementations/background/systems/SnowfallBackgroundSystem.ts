import type { Dimensions, QualityLevel } from "$shared/domain";
import { getOptimizedConfig } from "$shared/domain";
import type {
  ShootingStarState,
  Snowflake,
} from "$shared/domain/ui/backgrounds/BackgroundTypes";
import type { IBackgroundSystem } from "$shared/foundation/services/contracts/background/IBackgroundSystem";
