import type { AccessibilitySettings, Dimensions } from "$shared/domain";
import type { Star } from "$shared/domain/ui/backgrounds/BackgroundTypes";
import { type StarConfig, NightSkyUtils } from "./NightSkyUtils";
