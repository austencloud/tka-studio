import type { Dimensions } from "$shared/domain";
import { SnowfallConfig } from "$shared/domain";
import type { Snowflake } from "$shared/domain/ui/backgrounds/BackgroundTypes";
