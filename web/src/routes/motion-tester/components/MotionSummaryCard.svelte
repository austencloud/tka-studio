  ...
  <div class="motion-summaries">
    ...
    <div class="motion-summary blue-motion">
      <div class="motion-header">
        ...
        {#if showMotionTypes}
          <span
            class="complexity-badge {getMotionComplexity(
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="detail-value"
                    >{formatMotionType(
                      motionState.blueMotionParams.motionType
                    )}</span
                  >
                </div>
                <div class="detail-item">
                  ...
                  <span class="detail-value">
                    {formatLocation(motionState.blueMotionParams.startLoc)} → {formatLocation(
                      motionState.blueMotionParams.endLoc
                    )}
                  </span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value"
                    >{formatTurns(motionState.blueMotionParams.turns)}</span
                  >
                </div>
              </div>
            {:else}
              <div class="quick-stats">
                ...
                {:else if motionState.blueMotionParams.turns === "fl"}
                  <span class="stat-chip turns"> FL </span>
                {/if}
              </div>
            {/if}
          </div>
            ...
            {#if showFullDetails}
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="detail-value"
                    >{formatMotionType(
                      motionState.redMotionParams.motionType
                    )}</span
                  >
                </div>
                <div class="detail-item">
                  <span class="detail-label">Path:</span>
                  <span class="detail-value">
                    {formatLocation(motionState.redMotionParams.startLoc)} → {formatLocation(
                      motionState.redMotionParams.endLoc
                    )}
                  </span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                  <span class="detail-label">Turns:</span>
                  <span class="detail-value"
                    >{formatTurns(motionState.redMotionParams.turns)}</span
                  >
                </div>
              </div>
            {:else}
    ...
    <div class="sequence-info">
      <div class="info-item">
        ...
        <span class="info-value"
          >{motionState.gridType === "diamond" ? "Diamond" : "Box"}</span
        >
      </div>
      <div class="info-item">
        <span class="info-label">Sync Status:</span>
        <span
          class="info-value {motionState.animationState.isPlaying
            ? 'active'
            : 'paused'}"
        >
