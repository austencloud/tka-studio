    ...
    {#if debugState.stepByStepMode}
      <div class="step-controls">
        ...
        <div class="step-buttons">
          ...
          <button
            onclick={nextStep}
            disabled={debugState.currentStep >= debugState.maxSteps ||
      ...
      <div class="step-progress">
        <div class="progress-bar">
          <div
            class="progress-fill"
            style="width: {((debugState.currentStep + 1) /
              (debugState.maxSteps + 1)) *
              100}%"
          ></div>
        </div>
      </div>
    ...
    <div class="control-group">
      <label class="checkbox-label">
        <input
          ...
          onchange={(e) =>
            (debugState.showAdjustmentVectors = (
              e.target as HTMLInputElement
            ).checked)}
        />
    ...
    <div class="control-group">
      <label class="checkbox-label">
        <input
          ...
          onchange={(e) =>
            (debugState.autoUpdate = (e.target as HTMLInputElement).checked)}
        />
