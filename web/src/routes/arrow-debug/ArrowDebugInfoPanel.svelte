...
<div class="debug-info-panel">
  ...
  <section class="debug-section">
    <div
      ...
      onkeydown={(e) =>
        e.key === "Enter" || e.key === " "
          ? state.toggleSection("calculation_status")
          : null}
      role="button"
      tabindex="0"
    ...
    >
      ...
      <span
        class="toggle-icon {state.expandedSections.has('calculation_status')
          ? 'expanded'
          : ''}">▼</span
      >
    </div>
      ...
      <div class="section-content">
        ...
        {#if state.currentDebugData.timing}
          <div class="status-item">
            ...
            <span class="value"
              >{state.currentDebugData.timing.totalDuration.toFixed(2)}ms</span
            >
          </div>
        {/if}
  ...
  {#if isStepVisible(1)}
    <section class="debug-section step-section" data-status={getStepStatus(1)}>
      <div
        ...
        onkeydown={(e) =>
          e.key === "Enter" || e.key === " "
            ? state.toggleSection("location_calc")
            : null}
        role="button"
        tabindex="0"
      ...
      >
        ...
        <span
          class="toggle-icon {state.expandedSections.has('location_calc')
            ? 'expanded'
            : ''}">▼</span
        >
      </div>
          ...
          {#if state.currentDebugData.locationDebugInfo}
            <div class="debug-grid">
              <div class="debug-item">
                ...
                <span class="value"
                  >{state.currentDebugData.locationDebugInfo.motionType}</span
                >
              </div>
              <div class="debug-item">
                <span class="label">Start Orientation:</span>
                <span class="value"
                  >{state.currentDebugData.locationDebugInfo.startOri}</span
                >
              </div>
              <div class="debug-item">
                <span class="label">End Orientation:</span>
                <span class="value"
                  >{state.currentDebugData.locationDebugInfo.endOri}</span
                >
              </div>
              <div class="debug-item">
                <span class="label">Calculation Method:</span>
                <span class="value"
                  >{state.currentDebugData.locationDebugInfo
  ...
  {#if isStepVisible(2)}
    <section class="debug-section step-section" data-status={getStepStatus(2)}>
      <div
        ...
        onkeydown={(e) =>
          e.key === "Enter" || e.key === " "
            ? state.toggleSection("initial_pos")
            : null}
        role="button"
        tabindex="0"
      ...
      >
        ...
        <span
          class="toggle-icon {state.expandedSections.has('initial_pos')
            ? 'expanded'
            : ''}">▼</span
        >
      </div>
      ...
      {#if state.expandedSections.has("initial_pos")}
        <div class="section-content">
                ...
                <div class="debug-item">
                  ...
                  <span class="value"
                    >{state.currentDebugData.coordinateSystemDebugInfo
                      ...
                      .coordinateSystemDebugInfo.sceneDimensions[1]}</span
                  >
                </div>
                <div class="debug-item">
                  <span class="label">Used Coordinate Set:</span>
                  <span class="value coordinate-set"
                    >{state.currentDebugData.coordinateSystemDebugInfo
                      .usedCoordinateSet}</span
                  >
                </div>
                <div class="debug-item">
          ...
          {#if state.currentDebugData.timing?.stepDurations.initial_position}
            <div class="timing-info">
              Time: {state.currentDebugData.timing.stepDurations.initial_position.toFixed(
                2
              )}ms
            </div>
          {/if}
  ...
  {#if isStepVisible(3)}
    <section class="debug-section step-section" data-status={getStepStatus(3)}>
      <div
        ...
        onkeydown={(e) =>
          e.key === "Enter" || e.key === " "
            ? state.toggleSection("default_adj")
            : null}
        role="button"
        tabindex="0"
      ...
      >
        ...
        <span
          class="toggle-icon {state.expandedSections.has('default_adj')
            ? 'expanded'
            : ''}">▼</span
        >
      </div>
          ...
          {#if state.currentDebugData.defaultAdjustmentDebugInfo}
            <div class="debug-grid">
              ...
              <div class="debug-item">
                ...
                <span
                  class="value source-{state.currentDebugData
                    .defaultAdjustmentDebugInfo.adjustmentSource}"
                >
                  {state.currentDebugData.defaultAdjustmentDebugInfo
                    .adjustmentSource}
                </span>
  ...
  {#if isStepVisible(4)}
    <section class="debug-section step-section" data-status={getStepStatus(4)}>
      <div
        ...
        onkeydown={(e) =>
          e.key === "Enter" || e.key === " "
            ? state.toggleSection("special_adj")
            : null}
        role="button"
        tabindex="0"
      ...
      >
        ...
        <span
          class="toggle-icon {state.expandedSections.has('special_adj')
            ? 'expanded'
            : ''}">▼</span
        >
      </div>
          ...
          {#if state.currentDebugData.specialAdjustmentDebugInfo}
            <div class="debug-grid">
              ...
              <div class="debug-item">
                ...
                <span
                  class="value color-{state.currentDebugData
                    .specialAdjustmentDebugInfo.arrowColor}"
                >
              ...
              <div class="debug-item">
                ...
                <span
                  class="value {state.currentDebugData
                    .specialAdjustmentDebugInfo.specialPlacementFound
                    ? 'found'
                    : 'not-found'}"
                >
                  {state.currentDebugData.specialAdjustmentDebugInfo
              ...
              <div class="debug-item">
                ...
                <span
                  class="value source-{state.currentDebugData
                    .specialAdjustmentDebugInfo.adjustmentSource}"
                >
                  {state.currentDebugData.specialAdjustmentDebugInfo
                    .adjustmentSource}
                </span>
  ...
  {#if isStepVisible(5)}
    <section class="debug-section step-section" data-status={getStepStatus(5)}>
      <div
        ...
        onkeydown={(e) =>
          e.key === "Enter" || e.key === " "
            ? state.toggleSection("final_result")
            : null}
        role="button"
        tabindex="0"
      ...
      >
        ...
        <span
          class="toggle-icon {state.expandedSections.has('final_result')
            ? 'expanded'
            : ''}">▼</span
        >
      </div>
            ...
            <div class="tuple-processing-info">
              ...
              <div class="debug-grid">
                ...
                <div class="debug-item">
                  ...
                  <span class="value"
                    >({state.currentDebugData.tupleProcessingDebugInfo
                      .selectedTuple[0]}, {state.currentDebugData
                      .tupleProcessingDebugInfo.selectedTuple[1]})</span
                  >
                </div>
                <div class="debug-item">
            ...
            <div class="calculation-breakdown">
              ...
              <div class="breakdown-step">
                ...
                <span class="breakdown-value"
                  >{formatPoint(state.currentDebugData.initialPosition)}</span
                >
              </div>
              <div class="breakdown-step">
                ...
                <span class="breakdown-value"
                  >{formatPoint(
                    state.currentDebugData.tupleProcessedAdjustment
                  )}</span
                >
              </div>
              <div class="breakdown-step final-calc">
                ...
                <span class="breakdown-value"
                  >{formatPoint(state.currentDebugData.finalPosition)}</span
                >
              </div>
            </div>
          {/if}
