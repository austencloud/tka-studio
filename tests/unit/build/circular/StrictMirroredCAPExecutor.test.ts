...
describe("StrictMirroredCAPExecutor", () => {
	...
	describe("Validation", () => {
		it("should accept valid mirrored position pairs - ALPHA2↔ALPHA8", () => {
			const startPos = createBeat(0, "START", null, GridPosition.ALPHA2, {}, {});
		...
		it("should accept valid mirrored position pairs - ALPHA3↔ALPHA7", () => {
			const startPos = createBeat(0, "START", null, GridPosition.ALPHA3, {}, {});
		...
		it("should accept valid mirrored position pairs - GAMMA1↔GAMMA9", () => {
			const startPos = createBeat(0, "START", null, GridPosition.GAMMA1, {}, {});
	...
	describe("Location Mirroring", () => {
		...
		it("should mirror NORTHEAST to NORTHWEST", () => {
			...
			const beat1 = createBeat(
				...
				GridPosition.ALPHA2,
				GridPosition.ALPHA8,
				{ startLocation: GridLocation.SOUTHWEST, endLocation: GridLocation.NORTHEAST },
				{ startLocation: GridLocation.NORTHEAST, endLocation: GridLocation.SOUTHWEST }
			);
			const sequence = [startPos, beat1];
	...
	describe("Prop Rotation Flipping", () => {
		it("should flip CLOCKWISE to COUNTER_CLOCKWISE", () => {
			const startPos = createBeat(
				...
				null,
				GridPosition.ALPHA2,
				{ endLocation: GridLocation.SOUTHWEST, propRotationDirection: RotationDirection.CLOCKWISE },
				{ endLocation: GridLocation.NORTHEAST, propRotationDirection: RotationDirection.CLOCKWISE }
			);
			const beat1 = createBeat(
				1,
				"A",
		...
		it("should flip COUNTER_CLOCKWISE to CLOCKWISE", () => {
			const startPos = createBeat(
				...
				null,
				GridPosition.ALPHA2,
				{ endLocation: GridLocation.SOUTHWEST, propRotationDirection: RotationDirection.COUNTER_CLOCKWISE },
				{ endLocation: GridLocation.NORTHEAST, propRotationDirection: RotationDirection.COUNTER_CLOCKWISE }
			);
			const beat1 = createBeat(
				1,
				"A",
		...
		it("should keep NO_ROTATION unchanged", () => {
			const startPos = createBeat(
				...
				null,
				GridPosition.ALPHA2,
				{ endLocation: GridLocation.SOUTHWEST, propRotationDirection: RotationDirection.NO_ROTATION },
				{ endLocation: GridLocation.NORTHEAST, propRotationDirection: RotationDirection.NO_ROTATION }
			);
			const beat1 = createBeat(
				1,
				"A",
	...
	describe("Sequence Completion", () => {
		...
		it("should double a 2-beat sequence to 4 beats + start", () => {
			const startPos = createBeat(0, "START", null, GridPosition.ALPHA2, {}, {});
			const beat1 = createBeat(1, "A", GridPosition.ALPHA2, GridPosition.ALPHA4, {}, {});
