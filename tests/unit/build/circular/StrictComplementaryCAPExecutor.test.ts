...
import { StrictComplementaryCAPExecutor } from "../../../../src/lib/modules/build/generate/circular/services/implementations";
...
describe("StrictComplementaryCAPExecutor", () => {
	...
	describe("Validation", () => {
		...
		it("should accept when end position equals start position - GAMMA9", () => {
			const startPos = createBeat(0, "START", null, GridPosition.GAMMA9, {}, {});
