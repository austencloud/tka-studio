...
class TestCoreImportHook(unittest.TestCase):
    ...
    def test_glassmorphism_styler_import(self):
        ...
        try:
            ...
            print("✅ Successfully imported GlassmorphismStyler via 'from core.glassmorphism_styler'")
    ...
    def test_import_from_different_locations(self):
        ...
        try:
            ...
            test_locations = [
                ...
                legacy_path / "src" / "main_window" / "main_widget" / "settings_dialog" / "ui" / "prop_type",
            ]
    ...
    def test_prop_button_functionality(self):
        ...
        try:
            ...
            print("✅ Successfully imported PropButton (which depends on core.glassmorphism_styler)")
    ...
    def test_hook_installation(self):
        ...
        finder_installed = any(isinstance(finder, CoreImportFinder) for finder in sys.meta_path)
        self.assertTrue(finder_installed, "CoreImportFinder should be installed in sys.meta_path")
    ...
    def test_hook_finds_correct_core(self):
        ...
        settings_core = any("settings_dialog" in str(core_dir) for core_dir in core_dirs)
        self.assertTrue(settings_core, "Should find settings_dialog core directory")
        print(f"✅ Found {len(core_dirs)} core directories including settings_dialog/core")
