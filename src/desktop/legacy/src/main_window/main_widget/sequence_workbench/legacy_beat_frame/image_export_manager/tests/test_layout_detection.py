...
from desktop.legacy.src.main_window.main_widget.sequence_workbench.legacy_beat_frame.image_export_manager.image_export_layout_handler import (
    ImageExportLayoutHandler,
)
from desktop.legacy.src.main_window.main_widget.sequence_workbench.legacy_beat_frame.beat_frame_layout_manager import (
