...
class CoreImportResolver:
    ...
    def resolve_core_import(self, module_name: str, requesting_file: Optional[str] = None) -> Optional[Path]:
        """
    ...
    def _context_aware_resolve(self, module_name: str, requesting_file: str) -> Optional[Path]:
        """
