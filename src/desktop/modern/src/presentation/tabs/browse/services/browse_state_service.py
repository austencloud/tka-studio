...
class BrowseStateService:
    ...
    def __init__(self, settings_file: Path):
        ...
        self._current_state: Optional[BrowseState] = None
    ...
    def set_selected_sequence(
        self, sequence_id: Optional[str], variation: Optional[int] = None
    ) -> None:
    ...
    def get_current_filter(self) -> tuple[Optional[FilterType], Any]:
