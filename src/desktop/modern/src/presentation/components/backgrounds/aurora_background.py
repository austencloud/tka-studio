...
from application.services.backgrounds.aurora.sparkle_animation import (
    AuroraSparkleAnimation,
)
from application.services.backgrounds.aurora.wave_effects import AuroraWaveEffects
