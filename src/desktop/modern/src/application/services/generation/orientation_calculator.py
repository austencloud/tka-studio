...
class MotionType(Enum):
    """Motion types from legacy system."""
    PRO = "pro"
    ANTI = "anti"
    STATIC = "static"
    DASH = "dash"
...
class Orientation(Enum):
    """Orientations from legacy system."""
    IN = "in"
    OUT = "out"
    CLOCK = "clock"
    COUNTER = "counter"
...
class OrientationCalculationService:
    ...
    def calculate_end_ori(self, beat_data: Dict[str, Any], color: str) -> str:
        ...
        print(f"  Motion: {motion_type}, Start: {start_ori}, Rot: {prop_rot_dir}, Turns: {turns}")
    ...
    def _calculate_dash_end_orientation(
        self, start_ori: str, prop_rot_dir: str, turns: float, start_loc: str, end_loc: str
    ) -> str:
