...
class SequenceServiceRegistrar(BaseServiceRegistrar):
    ...
    def register_services(self, container: "DIContainer") -> None:
        ...
        try:
            ...
            from application.services.sequence.beat_factory import (
                BeatFactory,
                IBeatFactory,
            )
            ...
            from application.services.sequence.sequence_start_position_service import (
            ...
            from core.interfaces.sequence_data_services import (
                ISequenceLoader,
