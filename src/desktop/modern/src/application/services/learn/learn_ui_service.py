...
class LearnUIService(ILearnUIService):
    ...
    def _get_default_font_sizes(self) -> Dict[str, int]:
        ...
        return {
            "title": 20, "subtitle": 16, "header": 16,
            "button": 14, "description": 12, "question_prompt": 16,
            "progress": 13, "lesson_button": 14, "answer_button": 12,
            "control_button": 14, "mode_label": 12, "mode_description": 10,
            "timer": 16, "results_title": 22, "results_stat": 14,
        }
    
    def _get_default_component_sizes(self) -> Dict[str, Tuple[int, int]]:
        """Get default component sizes as fallback."""
        return {
            "lesson_button": (200, 60), "answer_button": (150, 50),
            "go_back_button": (100, 40), "control_button": (120, 45),
            "question_display": (300, 200), "pictograph_view": (150, 150),
            "progress_bar": (250, 25), "timer_display": (150, 40),
            "mode_toggle": (300, 50), "results_panel": (400, 300),
            "results_stat": (200, 30),
        }
    ...
    def _get_default_spacing(self) -> Dict[str, int]:
        ...
        return {
            "main_layout": 10, "component": 5, "section": 15,
            "button_grid": 12, "answer_options": 18, "content_margin": 20,
            "text_spacing": 5, "lesson_selector": 10, "question_area": 15,
            "progress_area": 5,
        }
    ...
    def _get_default_colors(self) -> Dict[str, str]:
        ...
        return {
            "text_primary": "white", "text_secondary": "rgba(255, 255, 255, 0.8)",
            "text_muted": "rgba(255, 255, 255, 0.6)",
            "button_background": "rgba(255, 255, 255, 0.2)",
            "button_border": "rgba(255, 255, 255, 0.3)",
            "button_hover": "rgba(255, 255, 255, 0.3)",
            "button_pressed": "rgba(255, 255, 255, 0.4)",
            "correct_answer": "green", "incorrect_answer": "red",
            "neutral": "rgba(255, 255, 255, 0.5)",
            "progress_fill": "rgba(0, 255, 0, 0.7)",
            "progress_background": "rgba(255, 255, 255, 0.2)",
            "panel_background": "rgba(255, 255, 255, 0.1)",
