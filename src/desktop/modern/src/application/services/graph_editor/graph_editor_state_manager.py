...
class GraphEditorStateManager:
    ...
    def set_selected_beat(self, beat: Optional[BeatData], beat_index: Optional[int] = None) -> bool:
        """
    ...
    def clear_selection(self) -> bool:
        ...
        """
        had_selection = (
            self._selected_beat is not None or 
            self._selected_beat_index is not None or 
            self._selected_arrow_id is not None
        )
    ...
    def get_state_summary(self) -> dict:
        ...
        """
        return {
            "sequence_name": self._current_sequence.name if self._current_sequence else None,
            "selected_beat_index": self._selected_beat_index,
            "selected_beat_letter": self._selected_beat.letter if self._selected_beat else None,
