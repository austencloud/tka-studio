...
from application.services.ui.animation import setup_animation_services
...
class NewMainWidget:
    def __init__(self, container):
        ...
        from core.interfaces.animation_interfaces import IFadeOrchestrator
...
class GradualMigrationExample:
    def __init__(self, container):
        ...
        from core.interfaces.animation_interfaces import IFadeOrchestrator
        from application.services.ui.animation import LegacyFadeManagerAdapter
