...
class QuadrantIndexService:
    ...
    def get_quadrant_index(self, motion: MotionData, arrow_location: Location) -> Literal[0, 1, 2, 3]:
        """
    ...
    def _determine_grid_mode(self, motion: MotionData) -> str:
        ...
        if location in [Location.NORTHEAST, Location.SOUTHEAST, Location.SOUTHWEST, Location.NORTHWEST]:
            return "box"
        else:
            return "diamond"
    ...
    def _diamond_static_dash_quadrant_index(self, location: Location) -> Literal[0, 1, 2, 3]:
        """
