...
def register_letter_determination_services(container: DIContainer) -> None:
    ...
    try:
        ...
        from application.services.letter_determination.letter_determination_service import (
            LetterDeterminationService,
        )
        from application.services.letter_determination.motion_comparison_service import (
        ...
        try:
            from application.services.letter_determination.motion_attribute_service import (
