...
src_path = Path(__file__).parent.parent.parent.parent.parent / "src" / "desktop" / "modern" / "src"
...
def setup_environment_configuration():
    ...
    print("   export TKA_QUIET_POSITIONING=true     # Always use quiet positioning logs")
