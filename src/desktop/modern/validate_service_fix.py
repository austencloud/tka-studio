...
def test_application_startup_scenario():
    ...
    try:
        ...
        print("    ✅ EnhancedStartPositionPicker created successfully without services")
        ...
        if enhanced_picker.position_options:
            ...
            print("    ⚠️ No position options created (likely due to missing pool components)")
        ...
        print("    ✅ AdvancedStartPositionPicker created successfully without services")
...
def test_service_method_compatibility():
    ...
    try:
        ...
        try:
            ...
            print(f"    ⚠️ Service method call failed (expected in test environment): {e}")
...
def test_all_fallback_scenarios():
    ...
    try:
        # Mock pool manager
        class MockPool:
            def checkout_pictograph(self, parent=None): return None
        ...
        test_cases = [
            ...
            ("StartPositionPicker without services", lambda:
                __import__('presentation.components.start_position_picker.start_position_picker', fromlist=['StartPositionPicker']).StartPositionPicker(mock_pool)
            ),
