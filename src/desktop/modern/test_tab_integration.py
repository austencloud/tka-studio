...
def test_tab_factory_definitions():
    ...
    try:
        ...
        logger.error(f"❌ TabFactory test failed: {e}")
        return False
...
def test_service_registrar_imports():
    ...
    try:
        ...
        logger.error(f"❌ Service registrar test failed: {e}")
        return False
...
def test_generate_component_import():
    ...
    try:
        ...
        logger.error(f"❌ GeneratePanel component import failed: {e}")
        return False
...
def test_write_tab_import():
    ...
    try:
        ...
        logger.error(f"❌ WriteTab import failed: {e}")
        return False
...
def test_menu_bar_configuration():
    ...
    try:
        ...
        logger.error(f"❌ Menu bar test failed: {e}")
        return False
