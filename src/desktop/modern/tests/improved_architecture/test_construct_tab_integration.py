...
class TestConstructTabIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_container.register_instance(IWorkbenchStateManager, self.mock_state_manager)
    ...
    def test_construct_tab_connects_workbench_to_state_manager(self, mock_progress, mock_orchestrator, mock_animator, mock_connector, mock_factory):
        ...
        mock_factory_instance.create_workbench_panel.return_value = (Mock(), self.mock_workbench)
