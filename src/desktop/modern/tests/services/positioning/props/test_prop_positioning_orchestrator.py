"""
Tests for PropPositioningOrchestrator

Comprehensive tests to validate the modular architecture works correctly
and maintains backward compatibility with the original PropManagementService.
"""
...
class TestPropPositioningOrchestrator:
    ...
    def test_should_apply_beta_positioning_for_beta_letters(self, orchestrator, sample_beat_data):
    ...
    def test_calculate_separation_offsets_returns_points(self, orchestrator, sample_beat_data):
    ...
    def test_apply_beta_positioning_returns_beat_data(self, orchestrator, sample_beat_data):
    ...
    @patch('application.services.positioning.props.orchestration.prop_positioning_orchestrator.get_event_bus')
    def test_event_publishing_integration(self, mock_get_event_bus, orchestrator, sample_beat_data):
