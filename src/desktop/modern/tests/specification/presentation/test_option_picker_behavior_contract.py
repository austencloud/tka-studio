...
class TestOptionPickerBehaviorContract:
    ...
    def test_di_container_configuration(self):
        ...
        container.register_singleton(
            ISequenceWorkbenchService, SequenceManagementService
        )
    ...
    def test_option_picker_reactivity_contract(self):
        ...
        try:
            ...
            if hasattr(construct_tab, "layout_manager") and hasattr(
                ...
                assert (
                    initial_index == 0
                ), f"Expected start position picker (0), got {initial_index}"
            ...
            if hasattr(construct_tab, "workbench") and construct_tab.workbench:
                ...
                if hasattr(construct_tab.layout_manager, "picker_stack"):
                    current_index = (
                        construct_tab.layout_manager.picker_stack.currentIndex()
                    )
                    assert (
                        current_index == 1
                    ), f"Expected option picker (1) for sequence with beats, got {current_index}"
            ...
            if hasattr(construct_tab, "workbench") and construct_tab.workbench:
                if hasattr(construct_tab.workbench, "_handle_clear"):
                    ...
                    if hasattr(construct_tab.layout_manager, "picker_stack"):
                        ...
                        assert (
                            final_index == 0
                        ), f"Expected start position picker (0) after clear, got {final_index}"
            ...
            if hasattr(construct_tab, "workbench") and construct_tab.workbench:
                ...
                if hasattr(construct_tab.layout_manager, "picker_stack"):
                    ...
                    assert (
                        empty_index == 0
                    ), f"Expected start position picker (0) for empty sequence, got {empty_index}"
