...
def test_clear_sequence_fix():
    ...
    try:
        ...
        assert "word" in cleared_sequence_data[0], "Metadata should contain 'word' field"
        assert cleared_sequence_data[0]["word"] == "", "Word should be empty after clearing"
...
def test_minimal_sequence_startup():
    ...
    try:
        ...
        assert len(loaded_sequence_data) == 2, f"Expected 2 items (metadata + start position), got {len(loaded_sequence_data)}"
        ...
        assert "sequence_start_position" in start_pos, "Start position should have sequence_start_position"
...
def test_comprehensive_workflow():
    ...
    try:
        ...
        assert result['success_rate'] > 0.8, f"Success rate should be > 0.8, got {result['success_rate']}"
