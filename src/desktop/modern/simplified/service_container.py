...
class ServiceContainer:
    ...
    def register(self, interface: Type[T], implementation: Type[T] = None, instance: T = None) -> None:
    ...
    def get(self, service_class: Type[T]) -> T:
        ...
        if service_class not in self._services:
            ...
            for registered_interface, implementation in self._services.items():
                if (hasattr(registered_interface, '__name__') and 
                    hasattr(service_class, '__name__') and
                    registered_interface.__name__ == service_class.__name__):
