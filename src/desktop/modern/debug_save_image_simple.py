    ...
    try:
        ...
        class MockExportService:
            def export_sequence_image(self, sequence, file_path=None):
                print(f"🎭 Mock export called with sequence={sequence.name}, file_path={file_path}")
                return True, "Mock export successful"
        
        export_service = MockExportService()
        print(f"✅ Mock export service created")
        ...
        print(f"✅ Operation coordinator created")
        ...
        print(f"📊 Coordinator result: success={result.success}, message='{result.message}'")
