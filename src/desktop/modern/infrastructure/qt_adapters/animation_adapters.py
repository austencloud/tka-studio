...
class QtAnimationGroupAdapter:
    ...
    def add_animation(self, animation: PropertyAnimation) -> None:
        ...
        if isinstance(animation, QtPropertyAnimationAdapter):
            ...
            raise TypeError(f"Expected QtPropertyAnimationAdapter, got {type(animation)}")
...
def create_opacity_effect_adapter(qt_effect: QGraphicsOpacityEffect) -> QtOpacityEffectAdapter:
    """Create an opacity effect adapter for the given Qt graphics effect."""
    return QtOpacityEffectAdapter(qt_effect)


def create_property_animation_adapter(qt_animation: QPropertyAnimation) -> QtPropertyAnimationAdapter:
    """Create a property animation adapter for the given Qt animation."""
    return QtPropertyAnimationAdapter(qt_animation)


def create_animation_group_adapter(qt_group: QParallelAnimationGroup) -> QtAnimationGroupAdapter:
