...
class ExtendedMotionData(MotionData):
    ...
    def to_float_state(self, prefloat_motion_type: MotionType, prefloat_prop_rot_dir: RotationDirection) -> 'ExtendedMotionData':
    ...
    def with_prefloat_attributes(self, motion_type: MotionType, prop_rot_dir: RotationDirection) -> 'ExtendedMotionData':
    ...
    @classmethod
    def from_motion_data(cls, motion_data: MotionData, 
                        prefloat_motion_type: Optional[MotionType] = None,
                        prefloat_prop_rot_dir: Optional[RotationDirection] = None) -> 'ExtendedMotionData':
