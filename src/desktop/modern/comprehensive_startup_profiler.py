...
class ComprehensiveProfiler:
    ...
    def _generate_optimization_recommendations(self, sorted_timings, category_totals):
        ...
        heavy_operations = [(name, duration) for name, duration in sorted_timings if duration > 100]
...
def profile_complete_startup():
    ...
    try:
        ...
        with profiler.time_operation("10. Service registration"):
            ...
            window.orchestrator.service_manager.register_all_services(window.orchestrator.container)
        ...
        with profiler.time_operation("19. Background setup"):
            window.background_widget = window.orchestrator.background_manager.setup_background(
