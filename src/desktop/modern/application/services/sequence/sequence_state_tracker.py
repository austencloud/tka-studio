...
class SequenceStateTracker(QObject):
    ...
    def _setup_signal_connections(self):
        ...
        try:
            ...
            logger.exception(f"❌ Failed to setup signal connections: {e}")
    ...
    def _refresh_state_from_persistence(self):
        ...
        try:
            ...
            container.resolve(SequenceStartPositionManager)
    ...
    def cleanup(self):
        ...
        try:
            ...
            logger.exception(f"❌ Error during SequenceStateTracker cleanup: {e}")
