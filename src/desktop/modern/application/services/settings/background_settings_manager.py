...
class BackgroundSettingsManager(QObject, IBackgroundSettingsManager):
    """
    ...
    AVAILABLE_BACKGROUNDS = [
        "Snowfall", "AuroraBorealis", "Aurora", "Rainbow", 
        "Confetti", "Starfield", "Galaxy", "Nebula"
    ]
    ...
    def set_background(self, background_type: str) -> bool:
        ...
        try:
            ...
            if old_background != background_type:
                ...
                logger.info(f"Background changed from {old_background} to {background_type}")
