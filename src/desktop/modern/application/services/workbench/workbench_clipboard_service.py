...
class WorkbenchClipboardService:
    ...
    def is_clipboard_available(self) -> bool:
        ...
        try:
            return self._clipboard_adapter is not None and self._clipboard_adapter.is_available()
        except Exception as e:
    ...
    def get_clipboard_stats(self) -> dict:
        ...
        try:
            return {
                ...
                "adapter_type": type(self._clipboard_adapter).__name__ if self._clipboard_adapter else None
            }
        except Exception as e:
            return {
                "error": str(e),
