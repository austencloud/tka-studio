...
def run_final_validation():
    ...
    try:
        ...
        assert data_service_param.default is inspect.Parameter.empty, "data_service should be required (no default)"

        # Check that all service parameters are required in picker
        service_params = ['data_service', 'selection_service', 'ui_service', 'orchestrator']
