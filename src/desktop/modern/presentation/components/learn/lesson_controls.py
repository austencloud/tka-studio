...
class LessonControls(QWidget):
    ...
    def show_pause_button(self, show: bool) -> None:
        """
        ...
        """
        self._show_pause_button = show
        self.pause_button.setVisible(show)
        logger.debug(f"Pause button visibility: {show}")

    def show_restart_button(self, show: bool) -> None:
        """
        ...
        logger.debug(f"Restart button visibility: {show}")
    ...
    def set_pause_state(self, is_paused: bool) -> None:
        ...
        logger.debug(f"Pause state updated: {is_paused}")
    ...
    def is_pause_button_visible(self) -> bool:
        ...
        return self._show_pause_button
