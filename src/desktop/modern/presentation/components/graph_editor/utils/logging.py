...
class GraphEditorLogger:
    ...
    def info(self, message: str, context: Dict[str, Any] = None):
        ...
        full_message = f"[{self.component_name}] {message}{self._format_context(context)}"
    ...
    def method_call(self, method_name: str, args: Dict[str, Any] = None, result: Any = None):
    ...
    def validation_error(self, field: str, value: Any, error_message: str, context: Dict[str, Any] = None):
    ...
    def state_change(self, from_state: Any, to_state: Any, context: Dict[str, Any] = None):
    ...
    def performance_warning(self, operation: str, duration_ms: float, threshold_ms: float = 100, context: Dict[str, Any] = None):
        ...
        self.warning(f"Slow operation detected: {operation} took {duration_ms:.2f}ms", perf_context)
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if duration_ms > 100:  # 100ms threshold
                    logger.performance_warning(method_name, duration_ms, context=arg_context)
...
def log_error_with_context(logger: GraphEditorLogger, operation: str, context: Dict[str, Any] = None):
    """
...
def log_validation_errors(logger: GraphEditorLogger, validation_result, operation: str = "validation"):
    """
