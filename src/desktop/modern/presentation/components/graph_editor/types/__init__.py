"""
Graph Editor Types Package
==========================

Type definitions and enums for the graph editor.

This package will contain:
- Graph editor specific type definitions
- Animation type definitions
- Shared enums and constants
- Protocol definitions for interfaces

Currently empty - will be populated with future type safety improvements.
"""
