...
class LessonWorkspaceView(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        # Layout state
        self._current_layout_mode: Optional[LayoutMode] = None

        # Component placeholders (will be set by controller)
        self.question_display: Optional[QWidget] = None
        self.answer_options: Optional[QWidget] = None
        self.progress_controls: Optional[QWidget] = None
        self.lesson_timer: Optional[QWidget] = None
        self.lesson_controls: Optional[QWidget] = None
