...
class LearnTab(QWidget):
    ...
    def __init__(self, container: DIContainer, parent: Optional[QWidget] = None):
        ...
        self.coordinator: Optional[LearnTabCoordinator] = None
    ...
    def reset_to_selector(self) -> None:
        """Reset tab to lesson selector view."""
        if self.coordinator:
            self.coordinator.get_state_manager().transition_to_lesson_selector()
