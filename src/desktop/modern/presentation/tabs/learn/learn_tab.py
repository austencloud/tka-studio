...
class LearnTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        try:
            ...
            self.lesson_selector = LessonSelectorPanel(
                self.lesson_config_service, self.ui_service, self
            )
            ...
            self.results_panel = LessonResultsPanel(
                self.progress_service, self.ui_service, self
            )
    ...
    def _on_lesson_selected(self, lesson_type_str: str, mode_str: str) -> None:
        ...
        try:
            ...
            logger.info(
                f"Started lesson: {lesson_type.value} in {quiz_mode.value} mode"
            )
