...
from .views import LessonResultsView, LessonSelectorView, LessonWorkspaceView
...
class LearnTabCoordinator(QWidget):
    ...
    def __init__(self, container: DIContainer, parent: Optional[QWidget] = None):
        ...
        self.config_service: Optional[ILessonConfigurationService] = None
        self.session_service: Optional[IQuizSessionService] = None
        self.question_service: Optional[IQuestionGenerationService] = None
        self.validation_service: Optional[IAnswerValidationService] = None
        self.progress_service: Optional[ILessonProgressService] = None
        self.ui_service: Optional[ILearnUIService] = None

        # Views
        self.lesson_selector_view: Optional[LessonSelectorView] = None
        self.lesson_workspace_view: Optional[LessonWorkspaceView] = None
        self.lesson_results_view: Optional[LessonResultsView] = None

        # Controllers
        self.selector_controller: Optional[LessonSelectorController] = None
        self.workspace_controller: Optional[LessonWorkspaceController] = None
        self.results_controller: Optional[LessonResultsController] = None

        # Specialized components
        self.question_display: Optional[QuestionDisplay] = None
        self.answer_options: Optional[AnswerOptions] = None
        self.progress_controls: Optional[ProgressControls] = None
        self.lesson_timer: Optional[LessonTimer] = None
        self.lesson_controls: Optional[LessonControls] = None
