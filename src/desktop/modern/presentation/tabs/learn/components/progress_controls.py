...
class ProgressControls(QWidget):
    ...
    def update_progress(self, progress_info: ProgressInfo) -> None:
        ...
        try:
            ...
            logger.debug(f"Updated progress: {progress_info.current_question}/{progress_info.total_questions}")
    ...
    def _update_question_mode_display(self, progress_info: ProgressInfo) -> None:
        ...
        if progress_info.total_questions > 0:
            progress_percentage = (progress_info.questions_answered / progress_info.total_questions) * 100
        ...
        # Update accuracy
        self.accuracy_label.setText(f"Accuracy: {progress_info.accuracy_percentage:.0f}%")
    ...
    def _update_timer_mode_display(self, progress_info: ProgressInfo) -> None:
        ...
        self.question_label.setText(f"Questions Answered: {progress_info.questions_answered}")
