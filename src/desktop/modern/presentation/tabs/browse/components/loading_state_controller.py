...
class LoadingStateController:
    ...
    def __init__(
        self,
        loading_widget: Optional[QWidget] = None,
        browsing_widget: Optional[QWidget] = None,
        loading_progress_bar: Optional[QProgressBar] = None,
        loading_label: Optional[QLabel] = None,
    ):
        """
