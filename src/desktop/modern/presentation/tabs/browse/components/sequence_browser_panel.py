...
class SequenceBrowserPanel(QWidget):
    ...
    def __init__(
        ...
        self.thumbnail_factory: Optional[IThumbnailFactory] = None
        self.sequence_sorter: Optional[ISequenceSorter] = None
        self.layout_manager: Optional[ILayoutManager] = None
        self.loading_state_manager: Optional[ILoadingStateManager] = None
        self.navigation_handler: Optional[INavigationHandler] = None
        self.sequence_display_coordinator: Optional[
            SequenceDisplayCoordinatorService
        ] = None
        self.progressive_loading_handler: Optional[ProgressiveLoadingEventHandler] = (
            None
        )
