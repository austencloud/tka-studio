...
class ResilientPanelFactory:
    ...
    def __init__(
        ...
        self.circuit_breakers = {
            ...
            "start_position_picker": CircuitBreaker("start_position_picker", CircuitBreakerConfig()),
            ...
            "generate_controls": CircuitBreaker("generate_controls", CircuitBreakerConfig()),
        }
    ...
    def _execute_with_circuit_breaker(self, component_name: str, create_func: Callable, fallback_func: Callable):
        ...
        if not circuit_breaker.can_execute():
            ...
            return fallback_func(f"Circuit breaker protection: {component_name} temporarily unavailable")
        ...
        try:
            ...
            logger.error(f"Panel creation failed for {component_name}: {e}", exc_info=True)
    ...
    def _create_workbench_fallback(self, reason: str):
        ...
        label.setStyleSheet("color: red; font-size: 14px; padding: 20px; background-color: #ffe6e6;")
    ...
    def _create_start_position_fallback(self, reason: str):
        ...
        label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        label.setStyleSheet("color: orange; font-size: 14px; padding: 20px; background-color: #fff3e0;")
        layout.addWidget(label)
