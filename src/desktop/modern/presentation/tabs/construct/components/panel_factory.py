...
class PanelFactory:
    ...
    def create_start_position_panel(
        self,
    ) -> tuple[QWidget, Optional[StartPositionPicker]]:
    ...
    def create_graph_editor_panel(self) -> tuple[QWidget, Optional[object]]:
    ...
    def create_generate_controls_panel(self) -> tuple[QWidget, Optional[object]]:
