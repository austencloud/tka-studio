...
class ConstructTab(QWidget):
    ...
    def handle_generation_request(self, generation_config):
        ...
        # This method is called by the SignalCoordinator when generation is requested
        # For now, just emit completion signal - actual generation logic would go here
        print(f"🎯 ConstructTab: Handling generation request: {generation_config}")

        # Emit generation completed signal (success=True for now)
