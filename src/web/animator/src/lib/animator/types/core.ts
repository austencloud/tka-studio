 ...
 */
export function isUnifiedSequenceData(data: any): data is UnifiedSequenceData {
  return (
    data !== null &&
    data !== undefined &&
    typeof data === "object" &&
 ...
 */
export function isWebAppSequenceData(data: any): data is WebAppSequenceData {
  return (
    data !== null &&
    data !== undefined &&
    typeof data === "object" &&
 ...
 */
export function isLegacySequenceData(data: any): data is SequenceData {
...
export function convertPropAttributesToMotionData(
  ...
  return {
    motion_type: propAttrs.motion_type as any,
    prop_rot_dir: propAttrs.prop_rot_dir as any,
    start_loc: propAttrs.start_loc as any,
    end_loc: propAttrs.end_loc as any,
    turns: propAttrs.turns || 0,
    start_ori: propAttrs.start_ori as any,
    end_ori: propAttrs.end_ori as any,
    is_visible: true,
    metadata: {},
  };
}
