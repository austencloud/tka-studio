...
function calculateProTargetAngle(
  startCenterAngle,
  targetCenterAngle,
  startStaffAngle,
  turns,
    ...
    case "pro":
      ...
      if (turns > 0) {
        ...
        calculatedTargetStaffAngle =
          calculateProIsolationStaffAngle(targetCenterAngle);
      }
      break;
    case "anti":
...
function MotionParameterPanel($$payload, $$props) {
  ...
  $$payload.out.push(
    `<div class="motion-params-panel svelte-1vo3bjc"><h2 class="svelte-1vo3bjc">🎯 Motion Parameters</h2> <div class="input-group svelte-1vo3bjc"><label class="svelte-1vo3bjc">Start Location</label> <div class="location-grid svelte-1vo3bjc"><!--[-->`,
  );
  for (
    ...
    for (
      ...
      if (location) {
        $$payload.out.push("<!--[-->");
        $$payload.out.push(
          `<button${attr_class("location-btn svelte-1vo3bjc", void 0, { active: state.motionParams.startLoc === location })}>${escape_html(location === "center" ? "⊙" : location.toUpperCase())}</button>`,
        );
      } else {
        $$payload.out.push("<!--[!-->");
        $$payload.out.push(
          `<div class="location-spacer svelte-1vo3bjc"></div>`,
        );
      }
      $$payload.out.push(`<!--]-->`);
    }
  ...
  $$payload.out.push(
    `<!--]--></div></div> <div class="input-group svelte-1vo3bjc"><label class="svelte-1vo3bjc">End Location</label> <div class="location-grid svelte-1vo3bjc"><!--[-->`,
  );
  for (
    ...
    $$payload.out.push(`<div class="location-row svelte-1vo3bjc"><!--[-->`);
    for (
      let $$index_2 = 0, $$length2 = each_array_3.length;
      $$index_2 < $$length2;
      $$index_2++
    ) {
      ...
      if (location) {
        $$payload.out.push("<!--[-->");
        $$payload.out.push(
          `<button${attr_class("location-btn svelte-1vo3bjc", void 0, { active: state.motionParams.endLoc === location })}>${escape_html(location === "center" ? "⊙" : location.toUpperCase())}</button>`,
        );
      } else {
        $$payload.out.push("<!--[!-->");
        $$payload.out.push(
...
function createMotionTesterState() {
  ...
  let currentPropState = () => {
    ...
    const centerAngle = lerpAngle(
      endpoints.startCenterAngle,
      endpoints.targetCenterAngle,
      t,
    );
    const staffAngle = lerpAngle(
  ...
  let debugInfo = () => {
    ...
    const deltaAngle = normalizeAngleSigned(
