...
export const component = async () =>
  (component_cache ??= (
    await import("../entries/pages/motion-tester/_page.svelte.js")
  ).default);
export const imports = [
  "_app/immutable/nodes/4.BdY4EpCo.js",
...
export const stylesheets = ["_app/immutable/assets/4.Dp785hL8.css"];
export const fonts = [];
