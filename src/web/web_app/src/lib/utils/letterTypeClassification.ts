 ...
 */
export function getLetterBorderColor(letter: string | null | undefined): string {
 ...
 */
export function isLetterType(letter: string | null | undefined, type: LetterType): boolean {
