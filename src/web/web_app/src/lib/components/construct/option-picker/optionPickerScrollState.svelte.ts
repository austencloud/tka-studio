 ...
 */
export function createOptionPickerScrollState(initialProps: ScrollContainerProps) {
	...
	const hasIndividualSections = $derived(() => organizedPictographs.hasIndividual);
...
// ===== Type Export =====
export type OptionPickerScrollState = ReturnType<typeof createOptionPickerScrollState>;
 ...
 */
export function validateScrollStateProps(props: Partial<ScrollContainerProps>): {
	isValid: boolean;
	errors: string[];
	warnings: string[];
} {
