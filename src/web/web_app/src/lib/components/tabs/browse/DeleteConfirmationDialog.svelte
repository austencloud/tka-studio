...
-->
<script lang="ts">
	import type { DeleteConfirmationData } from '$lib/services/interfaces';
				...
				<div class="confirmation-message">
					...
					<div class="sequence-info">
						...
						{#if confirmationData.sequence.author}
							<div class="sequence-author">by {confirmationData.sequence.author}</div>
						{/if}
						{#if confirmationData.sequence.sequenceLength}
							<div class="sequence-length">{confirmationData.sequence.sequenceLength} beats</div>
						{/if}
					</div>
						...
						<div class="warning-details">
							...
							<ul>
								{#if confirmationData.relatedDataCount.thumbnails > 0}
									<li>{confirmationData.relatedDataCount.thumbnails} thumbnail(s)</li>
								{/if}
								{#if confirmationData.relatedDataCount.variations > 0}
									<li>{confirmationData.relatedDataCount.variations} variation(s)</li>
								{/if}
