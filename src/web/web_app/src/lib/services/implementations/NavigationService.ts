...
export interface INavigationService {
	...
	toggleSectionExpansion(sectionId: string, sections: NavigationSection[]): NavigationSection[];
...
export class NavigationService implements INavigationService {
	...
	getSequencesForNavigationItem(
		...
		switch (sectionType) {
			...
			case 'letter':
				return allSequences.filter((seq) => seq.word.startsWith(item.value as string));
