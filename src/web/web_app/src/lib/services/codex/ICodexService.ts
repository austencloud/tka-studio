...
export interface ICodexService {
	 ...
	 */
	rotateAllPictographs(pictographs: PictographData[]): Promise<PictographData[]>;
	
	/**
	 * Apply mirror operation to all pictographs
	 */
	mirrorAllPictographs(pictographs: PictographData[]): Promise<PictographData[]>;
	
	/**
	 * Apply color swap operation to all pictographs
	 */
	colorSwapAllPictographs(pictographs: PictographData[]): Promise<PictographData[]>;
