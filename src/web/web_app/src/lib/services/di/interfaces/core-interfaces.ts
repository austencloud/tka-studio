...
export const ISequenceServiceInterface = createServiceInterface<ISequenceService>(
	'ISequenceService',
...
export const ISequenceDomainServiceInterface = createServiceInterface<ISequenceDomainService>(
	'ISequenceDomainService',
	SequenceDomainService
);

export const IPictographServiceInterface = createServiceInterface<IPictographService>(
	'IPictographService',
...
export const IPropRenderingServiceInterface = createServiceInterface<IPropRenderingService>(
	'IPropRenderingService',
	PropRenderingService
);

// Infrastructure services
export const IPersistenceServiceInterface = createServiceInterface<IPersistenceService>(
	'IPersistenceService',
	LocalStoragePersistenceService
);

export const ISettingsServiceInterface = createServiceInterface<ISettingsService>(
	'ISettingsService',
	SettingsService
);

export const IDeviceDetectionServiceInterface = createServiceInterface<IDeviceDetectionService>(
	'IDeviceDetectionService',
...
// Generation services
export const IMotionGenerationServiceInterface = createServiceInterface<IMotionGenerationService>(
	'IMotionGenerationService',
...
export const IOptionDataServiceInterface = createServiceInterface<IOptionDataService>(
	'IOptionDataService',
	OptionDataService
);

export const IStartPositionServiceInterface = createServiceInterface<IStartPositionService>(
	'IStartPositionService',
