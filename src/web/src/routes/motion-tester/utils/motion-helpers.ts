...
export function getAvailableMotionTypes(startLoc: string, endLoc: string): string[] {
...
export function getMotionDescription(startLoc: string, endLoc: string, motionType: string, turns: number): string {
...
export function getRotationDirection(startLoc: string, endLoc: string, motionType: string, turns: number): string {
