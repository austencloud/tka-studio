...
class ServiceRegistrationManager(IServiceRegistrationManager):
    ...
    def register_event_system(self, container: "DIContainer") -> None:
        ...
        """
        try:
            from desktop.modern.core.commands import CommandProcessor
            from desktop.modern.core.events import IEventBus, get_event_bus
    ...
    def register_sequence_services(self, container: "DIContainer") -> None:
        ...
        from shared.application.services.sequence.beat_factory import BeatFactory, IBeatFactory
    ...
    def register_pictograph_services(self, container: "DIContainer") -> None:
        ...
        from desktop.modern.core.interfaces.pictograph_services import IScalingService
    ...
    def register_positioning_services(self, container: "DIContainer") -> None:
        ...
        try:
            ...
            from desktop.modern.application.services.positioning.props.orchestration.prop_orchestrator import (  # Register remaining orchestrators
                IPropOrchestrator,
                PropOrchestrator,
            )
