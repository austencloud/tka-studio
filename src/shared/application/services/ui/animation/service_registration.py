...
from .core_components import GraphicsEffectManager, AnimationFactory
...
def create_fade_orchestrator_for_testing(settings_coordinator) -> IFadeOrchestrator:
    ...
    animation_service = AnimationService(effect_manager, animation_factory, settings_provider)
    stack_animation_service = StackAnimationService(animation_service)
    
    return FadeOrchestrator(animation_service, stack_animation_service, settings_provider)
