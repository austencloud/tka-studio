...
class StartPositionDataService(IStartPositionDataService):
    ...
    def get_position_data(self, position_key: str, grid_mode: str = "diamond") -> Optional[PictographData]:
        ...
        """
        try:
            logger.debug(f"Retrieving position data for {position_key} in {grid_mode} mode")
            ...
            if pictograph_data:
                ...
                logger.warning(f"No position data found for {position_key} in {grid_mode} mode")
                return None
    ...
    def get_position_beat_data(self, position_key: str, grid_mode: str = "diamond") -> Optional[BeatData]:
        ...
        try:
            ...
            if beat_data:
                ...
                logger.warning(f"No beat data found for {position_key} in {grid_mode} mode")
                return None
    ...
    def _get_cached_position_data(self, position_key: str, grid_mode: str) -> Optional[PictographData]:
        """
