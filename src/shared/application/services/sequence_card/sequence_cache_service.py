...
from desktop.modern.core.interfaces.sequence_card_services import ISequenceCardCacheService, CacheStats, CacheLevel
...
class SequenceCardCacheService(ISequenceCardCacheService):
    ...
    def optimize_memory_usage(self) -> None:
        ...
        try:
            ...
            if current_memory > self.memory_limit_mb:
                ...
                gc.collect()
                logger.info(f"Memory optimization: cleared cache entries, memory: {current_memory:.1f}MB")
        except ImportError:
    ...
    def _estimate_memory_usage(self) -> int:
        ...
        return (self.raw_cache.size() + self.scaled_cache.size()) * 1024 * 1024  # 1MB per image estimate
