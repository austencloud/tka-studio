...
import logging
from desktop.modern.core.interfaces.sequence_card_services import ISequenceCardSettingsService
...
class SequenceCardSettingsService(ISequenceCardSettingsService):
    ...
    def get_last_selected_length(self) -> int:
        ...
        try:
            if self.settings_service:
                return self.settings_service.get_setting(self.section, "last_length", 16)
            else:
    ...
    def get_column_count(self) -> int:
        ...
        try:
            if self.settings_service:
                return self.settings_service.get_setting(self.section, "column_count", 2)
            else:
