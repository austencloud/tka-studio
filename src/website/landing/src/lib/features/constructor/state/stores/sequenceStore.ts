...
export type { BeatData, SequenceState } from './sequence/SequenceContainer.js';
...
} from './sequence/sequenceAdapter.js';

// Export the container for modern usage
export { sequenceContainer } from './sequence/SequenceContainer.js';
