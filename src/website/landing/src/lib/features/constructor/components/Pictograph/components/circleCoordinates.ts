export const circleCoordinates = {
  ...
  box: {
    ...
    layer2_points: {
      normal: {
        n_box_layer2_point: "(475, 331.9)",
        e_box_layer2_point: "(618.1, 475)",
        s_box_layer2_point: "(475, 618.1)",
        w_box_layer2_point: "(331.9, 475)"
      },
      strict: {
        n_box_layer2_point_strict: "(475, 325.0)",
        e_box_layer2_point_strict: "(625.0, 475)",
        s_box_layer2_point_strict: "(475, 625.0)",
        w_box_layer2_point_strict: "(325.0, 475)"
      }
    },
    outer_points: {
      ne_box_outer_point: "(775, 175)",
      se_box_outer_point: "(775, 775)",
      sw_box_outer_point: "(175, 775)",
      nw_box_outer_point: "(175, 175)"
    },
    center_point: "(475.0, 475.0)"
  }
};
