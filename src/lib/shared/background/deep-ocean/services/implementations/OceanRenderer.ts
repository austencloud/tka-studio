...
import type { MarineLife, Bubble, OceanParticle, FishMarineLife, JellyfishMarineLife } from "../../domain/models/DeepOceanModels";
...
export class OceanRenderer implements IOceanRenderer {
    ...
    private drawJellyfish(ctx: CanvasRenderingContext2D, jelly: JellyfishMarineLife): void {
