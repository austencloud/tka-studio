...
>
  <div class="auth-sheet__container">
    ...
    <div class="auth-sheet__content">
      <!-- Social Auth Buttons - Only show in sign-in mode -->
      {#if authMode === "signin"}
        <div class="auth-sheet__social" transition:slide={{ duration: 250 }}>
          <SocialAuthButton provider="facebook" class="auth-sheet__facebook-btn">
            <svg
          ...
          <SocialAuthButton provider="google" class="auth-sheet__google-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <!-- Divider -->
        <div class="auth-sheet__divider" transition:slide={{ duration: 200 }}>
      ...
      <!-- Compact social auth option when in sign-up mode -->
      {#if authMode === "signup"}
        <div class="auth-sheet__social-compact" transition:slide={{ duration: 200 }}>
          <p class="social-compact-label">Or sign up with</p>
