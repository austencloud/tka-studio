...
export interface IShareService {
   ...
   */
  generatePreview(sequence: SequenceData, options: ShareOptions): Promise<string>;
  
  /**
   * Download sequence as image file
   * Simple download functionality - the core feature users need
   */
  downloadImage(sequence: SequenceData, options: ShareOptions, filename?: string): Promise<void>;
