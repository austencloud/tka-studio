...
<script lang="ts">
  ...
  import AnimationControls from "$build/animate/components/AnimationControls.svelte";
  import GifExportDialog from "$build/animate/components/GifExportDialog.svelte";
  ...
  import type { PropState } from "$build/animate/domain/types/PropState";
