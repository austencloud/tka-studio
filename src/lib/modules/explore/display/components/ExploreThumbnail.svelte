...
<script lang="ts">
  ...
  import ThumbnailActions from "./ExploreThumbnailActions.svelte";
  import ThumbnailImage from "./ExploreThumbnailImage.svelte";
  import ThumbnailMetadata from "./ExploreThumbnailMetadata.svelte";
