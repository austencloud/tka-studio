...
export class BubblesBackgroundSystem implements BackgroundSystem {
	...
	private drawBubbles(ctx: CanvasRenderingContext2D, dimensions: Dimensions): void {
		for (const bubble of this.bubbles) {
			...
			bubbleGradient.addColorStop(0, `rgba(${bubble.color.r}, ${bubble.color.g}, ${bubble.color.b}, 0.8)`);
			bubbleGradient.addColorStop(0.7, `rgba(${bubble.color.r}, ${bubble.color.g}, ${bubble.color.b}, 0.3)`);
			bubbleGradient.addColorStop(1, `rgba(${bubble.color.r}, ${bubble.color.g}, ${bubble.color.b}, 0.1)`);
