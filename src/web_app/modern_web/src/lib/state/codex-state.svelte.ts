...
export function createCodexState() {
	...
	async function performRotateOperation() {
		...
		try {
			...
			const rotatedPictographs = await codexService.rotateAllPictographs(pictographs);
	...
	async function performMirrorOperation() {
		...
		try {
			...
			const mirroredPictographs = await codexService.mirrorAllPictographs(pictographs);
	...
	async function performColorSwapOperation() {
		...
		try {
			...
			const swappedPictographs = await codexService.colorSwapAllPictographs(pictographs);
