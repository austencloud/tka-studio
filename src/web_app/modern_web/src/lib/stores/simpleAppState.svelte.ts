...
export function getActiveTab() { return appState.activeTab; }
export function getShowSettings() { return appState.showSettings; }
export function getTheme() { return appState.theme; }
export function getSettings() { return appState.settings; }
export function getIsInitialized() { return appState.isInitialized; }
export function getIsInitializing() { return appState.isInitializing; }
export function getInitializationError() { return appState.initializationError; }
export function getIsTransitioning() { return appState.isTransitioning; }

// Derived state
export function getIsReady() { 
    return appState.isInitialized && !appState.isInitializing && !appState.initializationError; 
}
