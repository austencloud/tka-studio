...
export class DashLocationCalculator implements IDashLocationCalculator {
	...
	private readonly LAMBDA_DASH_ZERO_TURNS_LOCATION_MAP: Record<string, Location> = {
		[`${Location.NORTH},${Location.SOUTH},${Location.WEST}`]: Location.EAST,
		[`${Location.EAST},${Location.WEST},${Location.SOUTH}`]: Location.NORTH,
		[`${Location.NORTH},${Location.SOUTH},${Location.EAST}`]: Location.WEST,
		[`${Location.WEST},${Location.EAST},${Location.SOUTH}`]: Location.NORTH,
	...
	private readonly DEFAULT_ZERO_TURNS_DASH_LOCATION_MAP: Record<string, Location> = {
	...
	private readonly NON_ZERO_TURNS_DASH_LOCATION_MAP: Record<string, Record<Location, Location>> =
		{
			clockwise: {
	...
	private getLambdaDashZeroTurnsLocation(motion: MotionData, otherMotion: MotionData): Location {
	...
	private getLambdaZeroTurnsLocation(motion: MotionData, otherMotion: MotionData): Location {
