# The Kinetic Constructor - Web Application

![The Kinetic Constructor](static/pwa/icon-192x192.png)

A modern web application for creating, visualizing, and sharing kinetic sequences and pictographs, built on the platform-agnostic architecture foundation.
