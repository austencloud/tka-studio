    ...
    def test_filter_button_clicks(self):
        ...
        for filter_type in filter_types:
            try:
                ...
                self.browse_tab.filter_selection_panel._on_filter_button_clicked(filter_type)
    ...
    def test_filter_service_operations(self):
        ...
        try:
            ...
            for filter_type in filter_types:
                ...
                filtered = self.browse_tab.browse_service.apply_filter(filter_type, None)
                print(f"  ✅ Filter {filter_type.value} returned {len(filtered)} sequences")
