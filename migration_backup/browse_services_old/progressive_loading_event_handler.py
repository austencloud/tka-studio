...
from desktop.modern.presentation.views.browse.services.loading_state_manager_service import (
    LoadingStateManagerService,
)
from desktop.modern.presentation.views.browse.services.sequence_display_coordinator_service import (
    SequenceDisplayCoordinatorService,
)
from desktop.modern.presentation.views.browse.services.sequence_sorter_service import (
