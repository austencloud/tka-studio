    ...
    def _check_circular_dependencies(self) -> tuple[bool, str]:
        ...
        try:
            ...
            if (
                ...
                return (
                    True,
                    "ApplicationOrchestrator creates successfully with dependencies",
                )
            else:
    ...
    def _check_application_factory(self) -> tuple[bool, str]:
        ...
        try:
            ...
            if "ServiceRegistrationHelper" in source:
                ...
                return (
                    False,
                    "ApplicationFactory does not use ServiceRegistrationHelper",
                )
...
def main():
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Run only essential checks"
    )
